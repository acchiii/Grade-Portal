...
urlpatterns = [
    ...
    path('portal-admin/add-teacher/', views.admin_add_teacher, name='admin_add_teacher'),
    ...
    path('portal-admin/add-subject/', views.admin_add_subject, name='admin_add_subject'),
    path('portal-admin/', views.admin_login, name='admin_login'),
    path('contact/', views.contact_view, name='contact'),
    path('portal-admin/panel/', views.admin_panel, name='admin_panel'),
]